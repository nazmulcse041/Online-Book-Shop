...
if(isset($_POST['reply_msg']))
    {
       ...
       $reply = $_POST['reply'];
        ...
        $sql = "UPDATE msg SET reply = '$reply' WHERE user_id = '$id'" ;
...
<html>
    ...
    <head>
        <title>Book Shopping : Admin Notifications</title>
        ...
        <section class="content">
            ...
            <section class="maincontent notifications">
                ...
                if(mysqli_num_rows($results)>0){
                    ...
                    echo "<table>";
                    echo "<tr><th>User Id</th><th>Email</th><th>Subject</th><th>User Message</th><th>My Reply</th><th>Submit</th></tr>";
                    while($obj = mysqli_fetch_assoc($results))
                    {   
                ...
                ?>  
                    <form method="post">
                        ...
                        <td><input type="text" name="reply" value="<?php echo $obj['reply']; ?>" /></td>
                        <td><input name="reply_msg" value="Reply" type="submit"/></td>
                        </tr>
                    </form>
                <?php
