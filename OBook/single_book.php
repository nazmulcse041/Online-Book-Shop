            ...
            <section class="maincontent single_book">
                ...
                <div class="single_book_right">
                      ...
                      <form method="post" action="cart_update.php">
                          <p style="color:#0897D6;font-size:20px"><span style="color:#000;">Author : </span><?php echo $obj->book_author ?></p><p style="color:#0897D6;font-size:20px"><span style="color:#000;">Price : </span><?php echo $currency , $obj->book_price ?></p>
