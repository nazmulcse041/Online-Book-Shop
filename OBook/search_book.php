...
$results = $mysqli->query("SELECT * FROM books natural join product_images where book_name Like  '%".$searchBook."%' OR book_author Like  '%".$searchBook."%' OR book_publishers Like  '%".$searchBook."%' OR book_category Like  '%".$searchBook."%' ");
